...
rows = ["Default", "Cachegen", "KIVI", "DuoAttn", "KVServe"]
...
cbar_ax = fig.add_subplot(gs_outer[0, 1])
...
ax1.set_title("Accuracy", fontsize=14, weight='bold', pad=15)
ax1.set_ylabel("Cache Type", fontsize=14, weight='bold', labelpad=15)
ax1.set_xlabel("")
...
ax2.set_title("Compression Ratio", fontsize=14, weight='bold', pad=15)
ax2.set_ylabel("")
ax2.set_xlabel("")
...
cbar_ax.tick_params(labelsize=11, length=0)  # length=0 隐藏刻度线
cbar_ax.set_ylabel("Metric Performance Rank", rotation=270, labelpad=5, weight='bold', fontsize=14)

# 布局
fig.text(0.52, 0.02, 'Dataset', ha='center', fontsize=14, weight='bold')
plt.subplots_adjust(bottom=0.15, right=0.9)
filename = "heatmap_unified_green_red.png"
