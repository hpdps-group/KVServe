...
class KVConnectorWorkerMemoryPlan:
    """GPU memory reserved for a worker-side connector before KV allocation."""
...
class KVConnectorBase_V1(ABC):
    ...
    def build_worker_memory_plan(
        ...
        """Plan connector-owned GPU memory before KV cache sizing."""
    ...
    def initialize_worker_memory(
        ...
        """Allocate memory described by ``build_worker_memory_plan``."""
        return
